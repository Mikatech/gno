...
func (t Time) After(u Time) bool { // OK
...
func (t Time) Before(u Time) bool { // OK
	if t.wall&u.wall&hasMonotonic != 0 {
		return t.ext < u.ext
	}
	ts := t.sec()
...
func (t Time) Equal(u Time) bool { // OK
	if t.wall&u.wall&hasMonotonic != 0 {
		return t.ext == u.ext
	}
...
func (d Weekday) String() string { //OK
